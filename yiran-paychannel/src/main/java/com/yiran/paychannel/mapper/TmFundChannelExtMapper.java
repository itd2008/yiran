 ...
 * @date 2019-04-19
 */
public interface TmFundChannelExtMapper 
{
	/**
     * 查询资金渠道特性信息
     * 
     ...
     * @return 结果
     */
	public int deleteTmFundChannelExtById(Integer extId);
	
	/**
     * 批量删除资金渠道特性
     * 
     * @param extIds 需要删除的数据ID
     * @return 结果
     */
	public int deleteTmFundChannelExtByIds(String[] extIds);
