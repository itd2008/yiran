 ...
 * @date 2019-06-13
 */
public interface WechatProductCouponMapper 
{
	/**
     * 查询商品优惠券信息
     * 
     ...
     * @return 结果
     */
	public int deleteWechatProductCouponById(Integer productCouponId);
     ...
     * @return 结果
     */
	public int deleteWechatProductCouponByIds(String[] productCouponIds);
