 ...
 * @date 2019-06-25
 */
public interface WechatProductInventoryMapper 
{
	/**
     * 查询商品进销存信息
     * 
     ...
     * @return 结果
     */
	public int deleteWechatProductInventoryById(Integer productInventoryId);
	
	/**
     * 批量删除商品进销存
     * 
     * @param productInventoryIds 需要删除的数据ID
     * @return 结果
     */
	public int deleteWechatProductInventoryByIds(String[] productInventoryIds);
